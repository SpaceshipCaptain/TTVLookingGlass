...
function guiConstructor(target) {
    ...
    guiObj.twitchIcon.setAttribute("src", chrome.runtime.getURL("icons/twitch.svg"));
    ...
    guiObj.kickIcon.setAttribute("src", chrome.runtime.getURL("icons/kick.svg"));
