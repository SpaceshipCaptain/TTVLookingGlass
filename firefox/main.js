...
const clipsdot = "div.Layout-sc-nxg1ff-0.eYzYtX"; //clips.twitch.tv selects div below and inserts above
const slashclips = "div.Layout-sc-nxg1ff-0.hhrWzV";  //twitch.tv/moonmoon/clips selects div below and inserts above
const slashvideos = "div.Layout-sc-nxg1ff-0.hhrWzV"; //twitch.tv/video/numbers selects div below and inserts above
const playertime = '.CoreText-sc-cpl358-0.cKlVwN[data-a-target="player-seekbar-current-time"]'; //.innertext of this selects the current vod time
const expresstarget = 'div.Layout-sc-nxg1ff-0.cpmuUc'; //express vod target left of prime loot crown
